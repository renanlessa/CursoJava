 ...
 * Essa classe representa todos os tipos de cartões web e 
 * conterá apenas um atributo: destinatario (tipo String). 
 * 
 * Nessa classe você deverá também declarar o método void showMessage(), que será abstrato. 
 * 
 * Crie classes filhas da classe CartaoWeb: DiaDosNamorados, Natal, Aniversario. 
 * 
 * Cada uma dessas classes deve conter um método construtor que receba o nome do destinatário 
 * do cartão. 
 * 
